...
class SingleItem extends StatefulWidget {
  ...
  SingleItem({this.isBool,
    this.productName,this.productUnit,
    this.productImage,
    this.productId,
    this.onDelete,this.wishList,
          ...
          child: Row(
            ...
            children: [
              Expanded(child: Container(
                height: 100,
                child: Center(
                  child: widget.productImage!=null? Image.asset (widget.productImage):Container()
                ),
              )),
                ...
                child: Column(
                  ...
                  children: [
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        widget.productName!=null?Text(widget.productName,
                   ...
                   widget.isBool==false? GestureDetector(
                    ...
                    :Text(widget.productUnit==null?"null":widget.productUnit),
                            ...
                            children: [
                              InkWell(onTap: (){
                                if(count==1){
                                  ...
                                  child: Icon(Icons.remove,color: prColor,size: 18,)),
                              Text('$count',
                              ...
                              InkWell(
                                onTap: (){
                                  ...
                                  child: Icon(Icons.add,color: prColor,size: 18,)),
                            ],
                          ),
                        ),
                      ):Container(),
